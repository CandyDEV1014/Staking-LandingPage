      ...
      <Container maxWidth="lg" sx={{ position: 'relative' }}>
        ...
        <Grid container spacing={5} direction="row-reverse" justifyContent="space-between" alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            <ContentStyle>
              <Box>
                <Typography component="p" variant="overline" sx={{ textTransform: 'none', marginBottom: 4, color: 'common.black', display: 'block', fontFamily: 'Montserrat', fontWeight: 600, fontSize: { xs: 40, md: 64 }, lineHeight: '60px', letterSpacing: 0 }}>
              ...
              <Box>
                <Typography component="p" sx={{ maxWidth: 540, marginBottom: 4, textTransform: 'none', color: '#7C7B7B', display: 'block', fontFamily: 'Poppins', fontWeight: 400, fontSize: 16, lineHeight: '28px', opacity: 0.6, margin: { xs: 'auto', md: 'auto auto 32px auto' } }}>
                    EquitySwap is a next-gen web3 asset manager that lets you invest in traditional assets with the benefits of blockchain technology
                </Typography>
              </Box>
            </ContentStyle>
          </Grid>
